...
public class LeaderElection1 extends TestMainClient {
    public static final Logger logger = Logger.getLogger(LeaderElection1.class);

    public LeaderElection1(String connectString, String root) {
        super(connectString);
        this.root = root;
        if (zk != null) {
            try {
    ...
    public static void main(String[] args) {
        ...
        LeaderElection1 le = new LeaderElection1(connectString, "/GroupMembers");
        try {
            le.findLeader();
        } catch (Exception e) {
            logger.error(e);
